...
export const FeaturedNextTripCard: React.FC<FeaturedNextTripCardProps> = ({ trip }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#FFF8F3] via-white to-[#F0FAF8] text-[#17201D] p-6 sm:p-8 shadow-md border border-[#EAE6DD]">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-white/80 backdrop-blur-md border border-[#EAE6DD] text-[#4A5551]">
          ...
          {/* Title & Destination */}
          <div>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-[#17201D] tracking-tight leading-tight">
              {trip.name}
            </h2>
            <p className="text-sm sm:text-base text-[#5E6B67] flex items-center gap-2 mt-1">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
            <div className="bg-white/70 border border-[#EAE6DD] rounded-2xl p-2.5">
              <div className="text-[11px] font-semibold text-[#A2B3AC] flex items-center gap-1">
                <Calendar className="w-3 h-3 text-[#FF6B4A]" />
                Dates
              </div>
              <div className="text-xs font-bold text-[#17201D] mt-0.5 truncate">
            ...
            <div className="bg-white/70 border border-[#EAE6DD] rounded-2xl p-2.5">
              ...
              <div className="text-xs font-bold text-[#17201D] mt-0.5">
          ...
          <div className="space-y-1.5 pt-1">
            <div className="flex items-center justify-between text-xs">
              <span className="font-semibold text-[#68736F]">Planning Readiness</span>
              <span className="font-extrabold text-[#17201D]">{progress.percentage}%</span>
            </div>
            <div className="w-full h-2.5 bg-[#DDF7F2] rounded-full overflow-hidden p-0.5">
              <div
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-white/80 hover:bg-white text-[#17201D] border border-[#D8E3DE] text-sm font-bold backdrop-blur-md transition-all cursor-pointer"
            >
